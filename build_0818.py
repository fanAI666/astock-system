# -*- coding: utf-8 -*-
"""
2026-08-18 盘后定稿引擎（复刻 build_final.py 6维评分 + 任务 step3 ATR 规则 + 用户风控基线）
数据源：腾讯公开端点 web.ifzq.gtimg.cn 拉日K(qfq,800,末棒滞后1日→qt.gtimg.cn 叠加当日收盘)，评分全自 K线推导。
候选池：现有 import_final.json(137) + 08-18 tool_filter(main_inflow>=1.5亿, 剔除涨停追高>9.5%) + high_dividend(>=4%)。
输出：选股结果/2026-08-18.md + 选股结果/import_final.json（合并去重，池只增不减）。
"""
...
NEW_SCREEN={
 # 08-18 主力净流入 >=1.5亿 top(剔除涨停/追高 ChangePCT>9.5)
 '000725':'京东方Ａ','605358':'立昂微','601288':'农业银行','688072':'拓荆科技','300433':'蓝思科技',
 '688630':'芯碁微装','688012':'中微公司','688205':'德科立','688677':'海泰新光','300666':'江丰电子',
 '688766':'普冉股份','600330':'天通股份','301377':'鼎泰高科','603259':'药明康德','002371':'北方华创',
 '688082':'盛美上海','300757':'罗博特科','601398':'工商银行','300475':'香农芯创','002714':'牧原股份',
 '688322':'奥比中光-W','603773':'沃格光电','300806':'斯迪克','688627':'精智达','000506':'招金黄金',
 '301666':'大普微-UW','688111':'金山办公','688017':'绿的谐波','002957':'科瑞技术','002741':'光华科技',
 '688521':'芯原股份','601899':'紫金矿业','002129':'TCL中环',
 # 08-18 高股息 >=4%（防御向补充；已在池者由脚本去重）
 '002763':'汇洁股份','603165':'荣晟环保','600329':'达仁堂','603508':'思维列控','603569':'长久物流',
 '603167':'渤海轮渡','300406':'九强生物','002004':'华邦健康','002572':'索菲亚','000913':'钱江摩托',
 '000915':'华特达因','300533':'冰川网络','603551':'奥普科技','600219':'南山铝业','600983':'惠而浦',
 '601216':'君正集团','002749':'国光股份','600866':'星湖科技','300994':'久祺股份','600066':'宇通客车',
 '300770':'新媒股份','601717':'中创智领','600153':'建发股份','600861':'北京人力','002271':'东方雨虹'}
