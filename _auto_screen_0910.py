# -*- coding: utf-8 -*-
"""
每日收盘选股定稿 (2026-09-10, 15:40)
- 刷新 import_final.json 中全部候选股日K线：用 proxy.finance.qq.com 镜像取近窗(保留3年历史)，按日期合并去重
- 叠加当日(09-10)收盘棒(qt.gtimg.cn 权威源，fqkline 端点滞后1日末根仍为 09-09)
- 基于含当日棒的日K重算 6 维评分 + 胜率估算
- 仅保留达标(胜率>=70%)标的 -> 写入 选股结果/2026-09-10.md
...
TODAY = '2026-09-10'
WIN_START = '2026-08-20'   # 近窗起点，足够覆盖 09-09 新增棒
WIN_COUNT = 40             # 近窗取最近 40 根（含滞后末根 09-09）
MIN_BARS = 250
