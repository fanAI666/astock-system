...
# ----- 评分 -----
# ⭐ 2026-08-10 加固：原阈值 30 根会让次新股（如 sh688797 臻宝科技上市仅34根）混入达标清单，
#    此时 MA60 退化为 MA<60、RSI/ATR 样本不足，指标不可信。改为 250 根(≈1年)，
#    保证 MA60 方向(需 120+ 根)与 RSI/ATR 统计稳定；被剔除者记入 SKIP_SHORT 供 MD 说明。
MIN_BARS=250
SKIP_SHORT=[]
