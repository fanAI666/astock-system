# -*- coding: utf-8 -*-
"""
2026-08-25 盘后定稿引擎（派生自 build_0821.py；周二 2026-08-25 收盘全量重跑）
数据源：现有 import_final.json(162) 复用内嵌日K + qt.gtimg.cn 叠加 08-25 收盘棒；
        新筛候选经 web.ifzq.gtimg.cn(qfq,800) 拉新鲜日K。评分全自 K线推导。
候选池：现有重评 + 08-25 tool_filter(main_inflow，剔除涨停追高>9.5%)。
输出：选股结果/2026-08-25.md + 选股结果/import_final.json（合并去重，池只增不减）。
"""
...
NEW_SCREEN={
 # 08-25 主力净流入>=1亿（剔除涨停/追高 ChangePCT>9.5%；已在池者由脚本去重）
 '600487':'亨通光电','603986':'兆易创新','600522':'中天科技','688256':'寒武纪','600183':'生益科技',
 '601869':'长飞光纤','603259':'药明康德','300489':'光智科技','002536':'飞龙股份','603186':'华正新材',
 '002475':'立讯精密','300394':'天孚通信','002594':'比亚迪','600498':'烽火通信','002437':'誉衡药业',
 '002636':'金安国纪','300602':'飞荣达','688519':'南亚新材','600330':'天通股份','300476':'胜宏科技',
 '002975':'博杰股份','301205':'联特科技','603618':'杭电股份','002714':'牧原股份','688300':'联瑞新材',
 '300570':'太辰光','000617':'中油资本','300759':'康龙化成','600105':'永鼎股份','300760':'迈瑞医疗',
 '300903':'科翔股份','300679':'电连技术','002851':'麦格米特','000811':'冰轮环境','300083':'创世纪',
 '300199':'翰宇药业','603083':'剑桥科技','300364':'中文在线','002558':'巨人网络','688596':'正帆科技',
 '002655':'共达电声',
}
...
lines.append('')
lines.append(f'- **数据日**：{DATE}（周二收盘盘后定稿）')
